"""Settings page - Interaction and context section mixins."""
...
class InteractionMixin(SettingsPageBase):
    """Mixin providing interaction mode and context settings functionality."""
