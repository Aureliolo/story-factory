"""Interview phase functions for StoryService."""
...
def start_interview(svc: StoryService, state: StoryState) -> str:
    """Begin the interview for the given story and record the assistant's initial questions.

    Parameters:
        svc: The StoryService instance.
        state: The story state representing the project to interview.

    Returns:
        The assistant's initial interview questions.
    """
...
def process_interview(svc: StoryService, state: StoryState, user_message: str) -> tuple[str, bool]:
...
def finalize_interview(svc: StoryService, state: StoryState) -> StoryBrief:
...
def continue_interview(svc: StoryService, state: StoryState, additional_info: str) -> str:
