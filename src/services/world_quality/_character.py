"""Character generation mixin for WorldQualityService."""
...
class CharacterMixin(WorldQualityServiceBase):
    """Mixin providing character generation with quality refinement."""
...
Write all text in {brief.language}."""
        ...
        try:
            ...
            character = _llm_client.generate_structured(
