"""Concept generation mixin for WorldQualityService."""
...
class ConceptMixin(WorldQualityServiceBase):
    """Mixin providing concept generation with quality refinement."""
...
Write all text in {brief.language}."""
        ...
        try:
            ...
            concept = _llm_client.generate_structured(
