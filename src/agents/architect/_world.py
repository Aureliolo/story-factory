"""WorldMixin - Methods for world-building, characters, locations, and relationships."""
...
class WorldMixin(ArchitectAgentBase):
    """Mixin providing world-building and character generation methods."""
