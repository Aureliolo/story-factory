"""Entity versioning operations mixin for WorldDatabase."""
...
if TYPE_CHECKING:
    ...
    _VersionMixinBase = WorldDatabaseBase
else:
    _VersionMixinBase = object

logger = logging.getLogger(__name__)


class VersionMixin(_VersionMixinBase):
    """Mixin providing entity versioning operations."""
    ...
    def _apply_version_retention(self, entity_id: str, cursor) -> None:
