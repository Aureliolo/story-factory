"""Refinement effectiveness analytics functions for ModeDatabase.

Handles refinement effectiveness summaries and progression data.
"""
...
def get_refinement_effectiveness_summary(
    ...
    """Summarize refinement-loop effectiveness for world entities over a recent time window.

    Parameters:
        db: ModeDatabase instance.
        entity_type: Optional filter for the entity type to include.
        days: Number of days to include in the analysis; must be non-negative.
    ...
    Returns:
        ...
        - best_is_final_rate: Percentage where best iteration equals returned iteration.
