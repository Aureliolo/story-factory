"""Base class for ModeDatabase with initialization and schema.

Contains database initialization, schema creation, and migrations.
"""
...
class ModeDatabaseBase:
    """Base class for model scoring database.
