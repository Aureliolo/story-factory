"""Prompt metrics mixin for ModeDatabase.

Handles prompt template usage tracking and analytics.
"""
...
class PromptMetricsMixin(ModeDatabaseBase):
    """Mixin providing prompt metrics operations."""
