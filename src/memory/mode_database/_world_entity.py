"""World entity scoring mixin for ModeDatabase.

Handles recording and retrieving world entity quality scores.
"""
...
class WorldEntityMixin(ModeDatabaseBase):
    """Mixin providing world entity scoring operations."""
