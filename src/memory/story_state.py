...
class WorldEventCreation(BaseModel):
    """A world event as generated by the LLM."""

    description: str = Field(min_length=1)
    year: int | None = None
    # Calendar systems can have up to 14 months (see WorldCalendar)
...
class StoryState(BaseModel):
    ...
    target_events_min: int | None = None  # Override min events for this project
    target_events_max: int | None = None  # Override max events for this project
