...
ALLOWED_LARGE_FILES: dict[str, str] = {
    ...
    "src/memory/world_database/_database.py": "SQLite + NetworkX world database with CRUD, queries, and migrations - should be split by concern",
    "src/memory/mode_database/_database.py": "Mode presets and custom mode management - should be split into presets and storage",
