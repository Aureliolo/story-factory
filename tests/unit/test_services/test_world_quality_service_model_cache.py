...
class TestCreatorModelCaching:
    ...
    def test_creator_model_stored_across_calls(self, mock_vram, service, mock_mode_service):
    ...
    @patch("src.settings.get_available_vram", return_value=16)
    def test_different_roles_resolved_independently(self, mock_vram, service, mock_mode_service):
...
class TestJudgeModelCaching:
    ...
    @patch("src.settings.get_available_vram", return_value=16)
    def test_judge_model_stored_across_calls(self, mock_vram, service, mock_mode_service, settings):
        """Second call for same role uses stored value instead of re-resolving."""
    ...
    @patch("src.settings.get_available_vram", return_value=16)
    def test_judge_model_swap_is_stored(self, mock_vram, service, mock_mode_service, settings):
...
class TestCacheInvalidation:
    ...
    @patch("src.settings.get_available_vram", return_value=16)
    def test_cache_invalidated_on_mode_change(self, mock_vram, service, mock_mode_service):
    ...
    def test_cache_invalidated_on_vram_change(self, mock_vram, service, mock_mode_service):
    ...
    def test_cache_invalidated_on_vram_strategy_change(
        self, mock_vram, service, mock_mode_service, settings
    ):
    ...
    @patch("src.settings.get_available_vram", return_value=16)
    def test_explicit_invalidation(self, mock_vram, service, mock_mode_service):
        """invalidate_model_cache() clears all storage."""
...
class TestCacheEfficiency:
    ...
    @patch("src.settings.get_available_vram", return_value=16)
    def test_mixed_entity_types_efficient_resolution(self, mock_vram, service, mock_mode_service):
