...
from memory.builtin_templates import (
    BUILTIN_STORY_TEMPLATES,
    BUILTIN_STRUCTURE_PRESETS,
)
from memory.story_state import Character, PlotPoint, StoryBrief, StoryState
...
class TemplateService:
    ...
    def create_template_from_project(
        ...
        from memory.templates import CharacterTemplate, PlotPointTemplate
